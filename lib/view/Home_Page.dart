...
import 'package:employee_app/view/Add_Employee.dart';
import 'package:employee_app/view/UpdateEmployee.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    var employeeDeletionProvider =
        Provider.of<EmployeeDeletionProvider>(context);
    return Scaffold(
                ...
                return Card(
                  child: ListTile(
                    ...
                    trailing: Row(
                      ...
                      children: [
                        Consumer<EditIconButtonProvider>(
                          builder: (context, editingProvider, _) {
                            return IconButton(
                                        ...
                                        actions: <Widget>[
                                          ...
                                          TextButton(
                                            onPressed: () async {
                                              ...
                                              editingProvider.startEditing();
                                              DataModel updatedEmployee =
                                                  DataModel(
                                                id: employee.id,
                                                name: 'name',
                                                email: 'email',
                                              ...
                                              try {
                                                ...
                                                Navigator.of(context).pop();
                                                // Stop editing and trigger UI update
                                                editingProvider.stopEditing();
                                              } catch (e) {
                                                print(
                        ...
                        Consumer<EmployeeDeletionProvider>(
                          builder: (context, deletionProvider, _) {
                            return IconButton(
